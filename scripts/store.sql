...
-- object: store | type: ROLE --
-- DROP ROLE IF EXISTS store;
CREATE ROLE store WITH 
	SUPERUSER
	CREATEDB
	LOGIN;
-- ddl-end --
...
CREATE SEQUENCE public.sec_emp
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_emp OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_payslip
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_payslip OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_inventory
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_inventory OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_movement
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_movement OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.payslip OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.employee OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_hour
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_hour OWNER TO postgres;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.hour OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_order
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_order OWNER TO store;
-- ddl-end --
...
CREATE SEQUENCE public.sec_user
	...
	OWNED BY NONE;
-- ddl-end --
ALTER SEQUENCE public.sec_user OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."user" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.sell OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."productType" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."operationType" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.inventory OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.size OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.operation OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.movement OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.rol OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.resource OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."userRol" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.activity OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."order" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.catalog OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."typeCatalog" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public."orderStatus" OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.customer OWNER TO store;
-- ddl-end --
...
-- ddl-end --
ALTER TABLE public.parameter OWNER TO store;
-- ddl-end --
